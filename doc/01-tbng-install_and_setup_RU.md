...
* -n — имя точки доступа (вашей будущей wifi сети) -— если не указано будет выбрано случайное значение. Полезно при тиражировании решения.

* -p — пароль для сети -— если не указано будет выбрано случайное значение. Полезно при тиражировании решения.
