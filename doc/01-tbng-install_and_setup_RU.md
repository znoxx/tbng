...
* -n — имя точки доступа (вашей будущей wifi сети) Если не указано будет выбрано случайное значение.

* -p — пароль для сети. Если не указано будет выбрано случайное значение.
